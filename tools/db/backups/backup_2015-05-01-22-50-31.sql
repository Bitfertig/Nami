...
-- Generation Time: May 01, 2015 at 22:50 PM ( Europe/Berlin )
...
CREATE TABLE `eventdates` (
  ...
  `startdate` varchar(255) NOT NULL COMMENT 'Cron Format',
...
INSERT INTO `eventdates` (`id`, `eventid`, `startdate`, `duration`) VALUES
(1, 1, '10 9 * * 1-5 *', 3600);
...
INSERT INTO `eventfiles` (`id`, `userid`, `name`) VALUES
(1, 1, '9ga.png');
